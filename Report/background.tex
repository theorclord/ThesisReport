...
\section{General definition of related game genres}
...
To design Archipelago, it was decided to use PCG in order to explore hybrid game mechanics. To understand what this implies in terms of technology, design and development, a description of the technical concept, as well as its common uses in game design will be provided in the following section.
...
We want to say that we are using unity in order to easily develop on several different platforms.
Other tool? 
Iterative development

\subsection{Unity3D Game Engine}
When proceeding to develop this game and the application part of it, we will be using the Unity3D Game Engine \cite{engine:unity}. The reason behind this decision is that it is a familiar environment, and that the tool makes it easy to create multi-platform applications. Unity has a built-in building kit that allows the applications to be built towards multiple platforms including Android, iOS, Windows, Web and more. 
