...
\end{quotation}
Analysing the data after playtesting must then take the whole context into account in order to properly understand the results. When analysing a hybrid game, a large number of questions will need to be answered. 
