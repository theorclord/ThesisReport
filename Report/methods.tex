...
\end{itemize}
It was not the first iteration of the implementation of a digital device in the flow of the game: an iteration of the procedurally generated archipelago map layout had been tested with the dice mechanic to further test the flow of the game (see appendix \ref ). However, it was the earliest prototype using both analogue components and 
