...
To properly manage the castle, the players must agree on splitting 
...
\item[Exploration Phase] After the management phase, the players chose an island 
\end{itemize}
\subsection{Specialization and collaboration}
\subsection{Risk, reward and PCG}
\subsection{}
...
\subsubsection{Rings}
Every island on the map has a ring around it. The color of the ring indicates whether the island is explored, unexplored or the goal, with the colors purple, white and blue respectively. Having these rings is a way to signify to the users where they have been, where they can go, and gives the players a quick and easy overview of the map situation.
