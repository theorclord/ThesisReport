...
\begin{figure}[!ht]
    ...
    \label{fig:base1}
\end{figure}
Based on Lim et al.'s framework to create relevant prototypes, the first iteration of \textit{Archipelago} is described by the main properties of prototypes.
...
A new design method for generating the events was then imagined. The technical details of how this methods are explained in the technical section of the report (see section \ref{sec:eventGeneration}). The design logic behind this system is determined as follows:
