...
\end{itemize}
The rooms can be upgraded three times, each time increasing the power of the room as well as its size. The rooms must then be organized wisely to correctly fit into the castle. 
