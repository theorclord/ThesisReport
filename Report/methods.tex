...
First the event structure of the final events will be explained. Then a short explanation of the first event generation, detailing where the project began and some of the limitations posed by it. This is followed by an explanation of the final event structure. After that the algorithm used to generate the events i detailed. Finally the how the flavor text is generated is explained.
...
\subsubsection{Event Algorithm}
In order to use the events in the game, they must be translated from the XML file to the structure visualized in figure \ref{fig:estruc}. 



The XML structure explained in the previous section is translated in to the events structured as shown in figure \ref{fig:eStruc}.
