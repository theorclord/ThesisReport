...
\end{itemize}
Those challenges were the main ones that the project should cover. To do so first required to find a game concept based on core mechanics that would allow the exploration of those challenge
\subsubsection{Finding a concept}

\subsubsection{A Collaborative Board Game}
During brainstorming, our 
