...
Through the work with developing \textit{Archipelago} as a hybrid game, many challenges to the ordinary approaches of board game design were discovered. Alone the challenge of creating such a game within an only slightly investigated field proved a challenge.
...
In hybrid games, the two parts must be supporting each other, while at the same time standing out in their own respective areas with their afforded features being a key motivator for designing the game.
