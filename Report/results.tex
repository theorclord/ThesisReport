...
The prototype described above is the last one that was built during this development period. It is the result of the combination of the game mechanics created for the purpose of experimenting with hybrid games and the implementation of PCG to create a new kind of play experience.
