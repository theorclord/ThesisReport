...
This thesis seeks to explore the possibilities of hybrid games through the design of one such game and implementing features which is not possible the analogue only counterpart.
...
The game was designed over several iterations with feedback gathered from each prototype, both within the team and in some cases from external playtest. 
