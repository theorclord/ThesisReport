...
\begin{abstract}
A new set of games is emerging as a combination of digital and analogue games. These hybrid games try to make use of digital components by the use of tablets, smartphones, and sometimes computers in collaboration with physical analogue tabletop games. 
...
The game was designed over several iterations with feedback gathered from each prototype, both within the team and from external playtests. Analysing the data gathered before, during and after the creation of the game provided results on such digital implementation in tabletop games. 
...
The game manages to produce features which cannot be easily reproduced in a non-digital context and which definitely would be cumbersome to manage in that situation. It also shows that there is potential in the use of digital components to solve complex calculations and that it can serve to add features which would be too intrusive in a non-digital setting.
This paper discovers some of the beneficial aspects of Procedural Content Generation implementation within a hybrid game solution and elaborates on different ways to utilise these discoveries along with other thought scenarios of implementation.
...
\bibitem{pic:golem}
Banks, D. (2014), \textit{Golem Arcana}[online]. Available at: \url{https://geekdad.com/2014/09/golem-arcana-reviewed/} [Accessed 1 June 2016].
...
\bibitem{pic:gar}
Hastings, E.J., Guha, R.K. and Stanley, K.O. (2009), \textit{Galactic Arms Race} [online]. Available at: \url{http://www.aigameresearch.org/portfolio-item/galactic-arms-race/}. [Accessed 1 June 2016].
...
\bibitem{pic:rogue}
King, A. (2015) \textit{Rogue} . Available at: \url{http://gamedevelopment.tutsplus.com/articles/the-key-design-elements-of-roguelikes--cms-23510} [online]. [Accessed 1 June 2016].

\bibitem{game:alch}
Kotry, M. (2014). \textit{Alchemists} [Board Game]. Czech Games Edition.

\bibitem{pic:xcomapp}
Keith Law, (2015), \textit{xcom board game app} [online]. Available at:\url{http://cdn.pastemagazine.com/www/articles/xcom\%20boardgame\%20app.jpg} [Accessed 1 June 2016].
...
\bibitem{pic:border}
RohinK, (2014), \textit{Borderlands Hardcore} [online]. Available at: \url{http://gamersyndrome.com/2015/video-games/borderlands-2-legendary-experience/} [Accessed 1 June 2016].
...
Stenros, J. and Waern, A. (2010). \textit{Games as Activity: Correcting the Digital Fallacy} [pdf]. Available at:
 \url{https://www.inter-disciplinary.net/wp-content/uploads/2010/06/Stenros-Waern-paper.pdf} . [Accessed 30 May. 2016].
...
\begin{figure}[!ht]
   ...
   \label{fig:gameflow}
\end{figure}
\chapter{Prototyping flavour text generation}
\begin{figure}[h]
    \centering
    \includegraphics[scale=0.18]{Images/flavor_building.jpg}
    \caption{Paper prototype used to show the guidelines of the event text generation. Each colour is used to differentiate where the different blocks of text should appear.}
    \label{fig:paper}
\end{figure}
...
\chapter{Game Rules}
\label{sec:rules}
\includepdf[pages=1-9, pagecommand={}]{RULESv5.pdf}
\end{document}