...
\begin{abstract}
A new set of games are emerging as a combination of digital and analogue games. These hybrid games try to make use of digital components by the use of tablets, smartphones, and sometimes computers in collaboration with physical analogue board games. 
This paper seeks to explore the possibilities of hybrid games through the design of one such game and implementing features which are not possible with only the analogue counterpart.
...
The game was designed over several iterations with feedback gathered from each prototype, both within the team and from external play tests. 
